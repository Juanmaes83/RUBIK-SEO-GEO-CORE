...
| CORE-8.1 | 🟡 Implementada en `feat/core-8-1-offpage-operations` ([PR #13](https://github.com/Juanmaes83/RUBIK-SEO-GEO-CORE/pull/13), apilado sobre #12; CI run [36203308792](https://github.com/Juanmaes83/RUBIK-SEO-GEO-CORE/actions/runs/36203308792) del HEAD `a0f59fa` verde en Node 20.20.2/22, 287/287 por job, 0 omitidas; pendiente de revisión humana), apilada sobre PR #12. Borradores y propuestas con evidencia aprobada y aprobación humana; sin publicación ni envío (D-24) |
| CORE-9 | 🟡 Solo preparación (D-25): [`PLATFORM-SPEC.md`](docs/core-9/PLATFORM-SPEC.md) y contratos con mocks ([PR #14](https://github.com/Juanmaes83/RUBIK-SEO-GEO-CORE/pull/14), apilado sobre #13; CI run [36203720653](https://github.com/Juanmaes83/RUBIK-SEO-GEO-CORE/actions/runs/36203720653) del HEAD `eabd93c` verde en Node 20.20.2/22, 296/296 por job, 0 omitidas; pendiente de revisión humana). ⛔ La implementación está bloqueada hasta que el propietario responda §10 (proyecto destino, infraestructura, proveedores, IA, legal) |
...
src/                       Core (UMD sin dependencias; materializer solo Node)
  ...
  rubik-seo-geo-offpage-ops.js   operación continua: datos aprobados, periodos, borradores, reseñas (D-24)
  rubik-seo-geo-platform-contracts.js  CORE-9: contratos y mocks de plataforma, sin conexiones (D-25)
