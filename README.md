...
| SEO off-page (CORE-8) | 🟡 PR #12 abierto, no fusionado. Los seis hallazgos de la auditoría están corregidos con regresiones (D-23). CI: pendiente del run de estas correcciones. Pendiente de revisión humana |
