...
| CORE-8.1 | 🟡 Implementada en `feat/core-8-1-offpage-operations` (PR apilado sobre #12, pendiente de CI y revisión), apilada sobre PR #12. Borradores y propuestas con evidencia aprobada y aprobación humana; sin publicación ni envío (D-24) |
