...
| CORE-9 | 🟡 Solo preparación (D-25): [`PLATFORM-SPEC.md`](docs/core-9/PLATFORM-SPEC.md) y contratos con mocks (PR apilado sobre #13, pendiente de CI y revisión). ⛔ La implementación está bloqueada hasta que el propietario responda §10 (proyecto destino, infraestructura, proveedores, IA, legal) |
