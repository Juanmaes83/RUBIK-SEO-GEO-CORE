...
| Compatibilidad Restaurant | ✅ golden de `publish()`/`preview()` sin cambios y materialización con 0 diferencias. CORE-3.2 elimina las rutas específicas de vertical en Intelligence; golden idéntico (blob `5aa93a3`) y contrato actualizado en D-18 |
...
| Siguiente fase | ✅ CORE-3.2 fusionado ([PR #7](https://github.com/Juanmaes83/RUBIK-SEO-GEO-CORE/pull/7), merge `3ad7b13`). Siguiente fase Core-only: CORE-6, contrato e implementación multidioma; CORE-2/4/5 y conexiones reales de CORE-7 requieren un host o Platform Layer fuera del alcance actual |
