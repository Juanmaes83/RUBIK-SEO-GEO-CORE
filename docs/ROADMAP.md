...
**Única fuente de estado del Core.** Estado actualizado el 25/09/2026: PR #12 (`feat/core-8-offpage-authority`, HEAD `42d213d`) abierto y mergeable; CI run `36129957035` verde en Node 20/22 (262/262 por job); revisión técnica pendiente con hallazgos por corregir. Todo cambio de código y documentación se hace solo en RUBIK-SEO-GEO-CORE. No se modifica ni se consulta WEB-RESTAURACI-N-PREMIUM-DIN-MICA ni ningún otro repositorio. Las lecturas externas requieren autorización expresa y concreta.
...
| **CORE-8** | **SEO off-page & Authority** ([`integrations/OFFPAGE-SERVICE.md`](integrations/OFFPAGE-SERVICE.md)) | 🟡 PR #12 abierto, CI verde (run `36129957035`: 262/262 en Node 20/22); no fusionado. Revisión encontró seis correcciones pendientes: confianza de mediciones falsificable, cobertura GEO por locale/mercado, ruptura por cambio de modelo, conflictos de evidencia entre periodos, minimización de metadatos y alcance semántico de la validación IA. Ver [`AUTONOMOUS-CONTINUATION.md`](AUTONOMOUS-CONTINUATION.md). No cerrar hasta corregir, añadir regresiones y pasar CI/revisión |
