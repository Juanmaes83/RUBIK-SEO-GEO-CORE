...
| **CORE-6** | **SEO multidioma:** traducciones reales, metadata por locale, Page Registry localizado, hreflang y canonical AUTO/CUSTOM por idioma | Siguiente fase Core-only tras CORE-3.2. Formalizar primero la decisión canónica D-19; no emitir hreflang para páginas inexistentes ni inventar traducciones. Mantener idéntica la salida de proyectos configurados solo con `es` |
