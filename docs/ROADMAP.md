...
| **CORE-9** | **Platform Layer multi-proyecto (fase final)** | Pendiente de CORE-8/8.1. Durante trabajo autónomo en este repo se permite avanzar la especificación, límites de datos/tenancy, arquitectura de referencia, contratos y mocks revisables. La aplicación de plataforma, autenticación real, secretos, proveedores/modelos live, almacenamiento, despliegue y cambios en otros repos requieren autorización y proyecto destino explícitos. El Project State, Studio, Media Library y Page Registry canónicos siguen en cada host |
