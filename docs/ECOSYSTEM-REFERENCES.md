...
|---|---|---|
| [open-seo](https://github.com/Juanmaes83/open-seo) | **Alto, integración futura** | Proveedor externo de crawl post-publicación y datos SEO mediante MCP. La integración está descrita en [OPENSEO.md](integrations/OPENSEO.md) y CORE-7.1. Requiere primero la interfaz inyectable de CORE-3, mocks de respuestas MCP y Platform Layer server-side. |
...
1. Ejecutar CORE-3 como indica [ROADMAP.md](ROADMAP.md): inyección explícita, derivación del adapter activo para Release E, corrección honesta de health y validación de rutas.
